...
template = """You are a programming assistant providing summary answers about the code base.

If the user asks a question about a specific code module, just answeer using information in the below context. 
...
QA_CHAIN_PROMPT_PROGRAMMING = PromptTemplate(input_variables=["context", "question"],template=template,)
